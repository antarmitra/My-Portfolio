    ...
    <section id="skill">
      <div className="px-[8%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white shadow-xl rounded-lg p-6 transition-shadow duration-300 hover:shadow-yellow-500/50">
          ...
          <div className="bg-white shadow-xl rounded-lg p-6 transition-shadow duration-300 hover:shadow-yellow-500/50">
            <img className="w-42 h-32 mx-auto mb-4" src={react} alt="react" />
            <h3 className="text-2xl font-semibold text-gray-800 text-center">
              React.Js
            </h3>
          </div>
